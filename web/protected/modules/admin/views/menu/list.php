			...
			<tr>
				...
				<td width="10">
					<?php 
						...
						if($item->id!=$item->last_brother->id&&($item->rgt!=$item->parent_node->rgt-1)){echo CHtml::link('<img src="'.yii::app()->baseUrl.'/style/admin/images/down.gif">',array('/admin/menu/moveDown/','id'=>$item->id));}
					?>
				</td>
