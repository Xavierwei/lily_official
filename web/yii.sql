...
(1, 'admin', 'admin1234', 1, 1, '超级管理员', 0, 'Mteddy@126.com', '15814449926', '中国', 1393325367, 1393325383, 1280, 1328864440, 1393325383),
(2, 'Teddy', '123456', 2, 1, '熊进超', 0, NULL, NULL, NULL, 1392199396, 1389761044, 15, 1380104029, 1393319811);
...
INSERT INTO `v_advertisement` (`id`, `name`, `link`, `advertising_id`, `photo1`, `code`, `audit`, `deadline`, `create_time`) VALUES
(1, '北京旅游', 'http://beijing.travel-cn.net/', 5, '/upload/image/advertisement/201402/20140208095322_57213.jpg', NULL, 1, 1577836800, 1336147508),
(2, '丽江旅游', 'http://lijiang.travel-cn.net/', 3, '/upload/image/advertisement/201402/20140208095725_14339.jpg', NULL, 1, 1577836800, 1336574871),
(3, '百度旅游', 'http://www.baidu.com/', 2, '/upload/image/advertisement/201402/20140210022300_68499.jpg', NULL, 1, 1391904000, 1391853926);
...
INSERT INTO `v_advertising` (`id`, `name`, `lft`, `rgt`, `parent`, `depth`, `audit`, `size`, `description`, `create_time`) VALUES
...
(5, '旅游攻略-广告', 9, 10, 0, 1, 1, '200*105', '', 1338774765);
...
('messageIndex', 0, '站 内 信访问', NULL, 'N;'),
('messageList', 0, '站 内 信列表', NULL, 'N;'),
('messageEdit', 0, '站 内 信编辑', NULL, 'N;'),
('messageAudit', 0, '站 内 信审核', NULL, 'N;'),
('messageAuditAll', 0, '站 内 信批量审核', NULL, 'N;'),
('messageUnAuditAll', 0, '站 内 信批量不审核', NULL, 'N;'),
('messageHot', 0, '站 内 信置热', NULL, 'N;'),
('messageRecommend', 0, '站 内 信推荐', NULL, 'N;'),
('messageMoveUp', 0, '站 内 信排序上移', NULL, 'N;'),
('messageMoveDown', 0, '站 内 信排序下移', NULL, 'N;'),
('messageDelete', 0, '站 内 信删除', NULL, 'N;'),
('messageDeleteAll', 0, '站 内 信批量删除', NULL, 'N;');
...
('超级管理员', 'messageAudit'),
('超级管理员', 'messageAuditAll'),
('超级管理员', 'messageDelete'),
('超级管理员', 'messageDeleteAll'),
('超级管理员', 'messageEdit'),
('超级管理员', 'messageHot'),
('超级管理员', 'messageIndex'),
('超级管理员', 'messageList'),
('超级管理员', 'messageMoveDown'),
('超级管理员', 'messageMoveUp'),
('超级管理员', 'messageRecommend'),
('超级管理员', 'messageUnAuditAll'),
('超级管理员', 'newsAudit'),
('超级管理员', 'newsAuditAll'),
('超级管理员', 'newsCreat'),
('超级管理员', 'newsDelete'),
...
INSERT INTO `v_friend_link` (`id`, `name`, `link`, `menu_id`, `photo1`, `webmaster`, `email`, `content`, `audit`, `create_time`) VALUES
(1, '百度', 'http://www.baidu.com/', 1, '/upload/image/friend_link/201402/20140225101930_66727.jpg', NULL, NULL, NULL, 1, 1329632690),
(2, '谷歌', 'http://www.google.com/', 1, NULL, NULL, NULL, NULL, 1, 1320583344),
(3, '新浪', 'http://www.sina.cn/', 1, NULL, NULL, NULL, NULL, 0, 1391843136);
...
(2, 'Teddy', 'e10adc3949ba59abbe56e057f20f883e', 1, '熊进超', 0, '13311002524', '380448100@qq.com', NULL, '', 0, 0, 0, 1389837785, 1393320272);
...
(1, '我和丽江有个约会', 8, NULL, 1, 1, 1, '/upload/image/news/201311/20131106075415_90779.jpg', '/upload/image/news/201311/20131106025439_75291.jpg', 1, 1, NULL, NULL, NULL, NULL, 1381464101, 1391829487),
(2, '台北风光无限好', 8, NULL, 1, 1, 1, '/upload/image/news/201402/20140208032015_55112.jpg', '/upload/image/news/201402/20140208032019_66867.jpg', 0, 0, NULL, NULL, NULL, NULL, 1391829475, 1391829619);
...
(2, '天津泥人张', 5, NULL, 1, 1, 1, '/upload/image/product/201401/20140115102150_68038.jpg', '/upload/image/product/201401/20140115102155_80076.jpg', 0, 0, 0, '150.00', '120.00', NULL, NULL, 1389781207, 1389949174);
...
('pvokduaf3scgl5cjt9p3ehqml0', 1393829997, '');
...
(1, '北京', '/upload/image/site/201402/20140225090016_87599.jpg', 'http://www.baidu.com/', '北京', 1393318816);
