    ...
    <div id='wrap'>
        ...
        <div class="page page_heritage">
            ...
            <div class="ha_mod ha_modL cs-clear limit">
                <div class="ha_modtxt left">
                    <h2>2014</h2>
                    <p>March, the 57th oversea store launched in East-Europe</p>
                    <p>March, win award "China business real-state corporate brand"</p>
                </div>
            </div>
            <!-- ha_mod -->
            <div class="ha_mod ha_modR cs-clear limit">
                <div class="ha_modtxt right">
                    <h2>2013</h2>
                    <p>March, the 57th oversea store launched in East-Europe</p>
                    <p>March, win award "China business real-state corporate brand"</p>
                </div>
            ...
            <!-- ha_mod -->
            <div class="ha_mod ha_modL ha_modbt cs-clear limit">
                <div class="ha_modtxt left">
                    <h2>2012</h2>
                    <p>March, the 57th oversea store launched in East-Europe</p>
                    <p>March, win award "China business real-state corporate brand"</p>
