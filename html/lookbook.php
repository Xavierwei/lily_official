    ...
    <div class="header">
        <ul id='nav'>
            ...
            <li class='item'>
                <h2>BRAND</h2>
                <ol>
                    <li><a href='#index?hash=brand_story' title='index' index='1'>BRAND STORY</a></li>
        ...
        <div class="page page_lookbook">
            <div class='limit cs-clear'>
                <div class="left">
                    ...
                    <div class="lb_modtit fadeout">GARDEN</div>
                    <div class="gohash lb_modtit fadeout" data-hash="s2">MODERN ART</div>
                    <div class="gohash lb_modtit fadeout" data-hash="s3">OCEAN</div>
                </div>
            ...
            <div class='limit cs-clear' id="s2">
                <div class="left middle lb_modtit fadeout">MODERN ART</div>
                <div class="lookbook_right">
            ...
            <div class='limit cs-clear' id="s3">
                <div class="left middle lb_modtit fadeout">OCEAN</div>
                <div class="lookbook_right">
