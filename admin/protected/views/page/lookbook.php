<div class="table-content" ng-controller="LookbookTable" ng-init="init()">
  ...
  <h5><a href="<?php echo Yii::app()->createAbsoluteUrl("page/addlookbook", array("gallery" => Yii::app()->getRequest()->getParam("gallery")))?>"><?php echo Yii::t("strings", "Add New Item")?></a></h5>
